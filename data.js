...
const ITEM = {
  ...
  // ── Fishing gear ──
  fishingrod: { n:'Fishing Rod',   icon:'🎣', col:'#a87a49', wt:3,  t:'fishingrod', slot:'mainhand', buyPrice:1, sellPrice:1 },

  // ── Fish (caught items) ──
  fishSmall:  { n:'Small Fish',    icon:'🐟', col:'#88bbff', wt:1,  t:'food', hp:30, sellPrice:8 },
  fishLarge:  { n:'Big Fish',      icon:'🐠', col:'#ff8855', wt:2,  t:'food', hp:55, sellPrice:18 },
  fishRare:   { n:'Golden Fish',   icon:'🐡', col:'#FFD700', wt:2,  t:'food', hp:80, sellPrice:45 },
  fishJunk:   { n:'Old Boot',      icon:'👞', col:'#775544', wt:3,  t:'junk',        sellPrice:1 },
  fishTreasure:{ n:'Sunken Ring',  icon:'💍', col:'#ddaaff', wt:1,  t:'ring', slot:'ring', def:2, hp:15, sellPrice:55 },
};
...
// Fishing catch table: [itemId, weight]  — higher weight = more common
const FISH_TABLE = [
  { id:'fishSmall',   w:50 },
  { id:'fishLarge',   w:25 },
  { id:'fishRare',    w:8  },
